...
const CHAMPIONS: Record<string, Champion> = {
  "zed": {
    ...
    difficulty: "Difícil",
    summary: "Assassino focado em burst e picks. Forte em 1v1 e em punir targets sem mobilidade.",
          ...
          <div className="p-6">
            ...
            <div className="mt-8 rounded-2xl border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-2 text-sm text-white/70">
                Daqui a pouco a gente vai transformar isso em “guias de verdade” com seções (matchups,
                combos, build situacional) e depois ligar em um banco (Supabase) para você adicionar campeões sem mexer no código.
              </p>
            </div>
          </div>
        </div>
